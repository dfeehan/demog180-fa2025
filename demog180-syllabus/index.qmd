...
<BR>
**Final exam**: December 16th, 8am-11am in Lewis 9 (our classroom)   
<BR>
...
The assignments are a critical part of the learning you will do in this class: they give you an opportunity to explore the topics we cover in the readings and in lecture on your own. They also give you a chance to practice your writing and your data analysis and programming skills.  

Labs are mostly completed in Jupyter notebooks. Labs are graded based on effort; therefore, you can get full credit on a lab even if you do not get all of the answers right. Labs must be handed in on time for full credit. You can drop one lab over the course of the semester.

Mini-projects will ask you to apply the skills you have learned in the labs to the analysis of real network datasets. Mini-projects are graded on correctness and must be handed in on time for full credit.  The goal is to give you a chance to start from scratch with a new network dataset and to demonstrate that you can perform an analysis on the network with minimal hand-holding.

Problem sets are graded on correctness and must be handed in on time for full credit. They are intended to help you engage with the kind of problem-solving question that could be asked on exams.
...
There will be two closed book examinations. The mid-term examination will be held during normal class time in our normal classroom; the timing of this midterm will be designed to assess your mastery of the core concepts in social networks. The final will be held during the final exam period (see the date/time above). The final exam will be cumulative and will take place during exam period.
