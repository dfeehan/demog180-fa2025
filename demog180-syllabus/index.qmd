...
* @menczer_first_2020 Sec. 5.4 (Preferential attachment)

### Network structure: advanced {#sec:advancedstructure}

Required reading:

* @menczer_first_2020 Sec. 5.3 (Configuration model; you can skip Exponential Random Graphs)
* @menczer_first_2020 Sec. 6.3 (Community detection; you can skim 6.3.2 and 6.3.3; be sure to read 6.3.4 on Stochastic Block Modeling)
